...
public class CodeDictionary {
    ...
    public final static ResultDto code002 = new ResultDto("400", "Client hasn't accounts!");
    public final static ResultDto code003 = new ResultDto("400", "Client hasn't enough money to transfer!");
